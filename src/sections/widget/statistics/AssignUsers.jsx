...
export default function AssignUsers() {
  ...
  return (
    <MainCard title="Assign Users to Blockchain Tasks">
        ...
        <Grid item xs={12}>
          <Stack direction="row" alignItems="center" justifyContent="space-between">
            <Stack direction="row" alignItems="center" spacing={2}>
              ...
              <Stack>
                <Typography variant="subtitle1">Afrikabal</Typography>
                <Typography variant="caption">@afrikabalproject</Typography>
              </Stack>
            </Stack>
            <IconButton
              color="secondary"
