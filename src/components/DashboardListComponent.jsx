...
// assets
import { Edit, Eye, InfoCircle, ProfileTick } from 'iconsax-react';
...
function DashboardCards({ widgetsData }) {
  return (
...
export default function List() {
  ...
  return (
    <>
      ...
      <DashboardCards widgetsData={widgetsData} />
      <ScrollX>
        {mockData.length === 0 ? <EmptyTables /> : <ReactTable data={mockData} columns={columns} />}
      </ScrollX>
    </>
  );
}
...
DashboardCards.propTypes = { widgetsData: PropTypes.array };
