...
export default function ThemeMenuLayout() {
  ...
  const handleContainerChange = (e) => {
    onChangeMiniDrawer(true); // Adjust drawer style to "mini"
    onChangeMenuOrientation(e.target.value); // Update menu orientation
  };

  return (
    <RadioGroup row aria-label="menu-layout" name="menu-layout" value={menuOrientation} onChange={handleContainerChange}>
            ...
            <Stack alignItems="center" spacing={0.5}>
              <MainCard
                ...
                sx={{
                  borderWidth: 2,
                  p: 1,
                  ...(!isHorizontal && { borderColor: theme.palette.primary.main }), // Highlight if selected
                }}
              >
