...
import { ThemeMode, HEADER_HEIGHT } from 'config';
...
export default function Customization() {
  ...
  const [menuMasterLoading, setMenuMasterLoading] = useState(false); // Replace dynamic loading state

  const container = 'container';
  const mode = ThemeMode.LIGHT;
  const presetColor = 'blue';
  const miniDrawer = false;
  const themeDirection = 'ltr';
  const menuOrientation = 'vertical';
  const menuCaption = true;
  const themeContrast = 'normal';
