...
function CreateForm({ lists, invoiceMaster }) {
  ...
  const handlerCreate = (values) => {
    ...
    console.log('Invoice Created:', newList); // For debugging
    openSnackbar({
      open: true,
...
export default function Create() {
  ...
  const isLoader = false; // No loader as no external API fetching is required
  const loader = (
  ...
  return (
    <>
      ...
      <MainCard>{isLoader ? loader : <CreateForm {...{ lists: [], invoiceMaster }} />}</MainCard>
    </>
  );
}
