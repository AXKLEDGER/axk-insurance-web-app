                      ...
                      <Box sx={{ p: 4.5, pb: 3, position: 'inherit', zIndex: 2 }}>
                        <Stack sx={{ color: 'background.paper' }}>
                          ...
                          <Typography variant="h6">
                            Discover how Afrikabal revolutionizes agriculture, commerce, and fintech using blockchain.
                          </Typography>
                      ...
                      >
                        <Grid container spacing={6}>
                          <Grid item xs={4}>
                            ...
                            >
                              <ListItemButton disableRipple component={Link} href="/dashboard">
                                <ListItemIcon>
                                  <Dot size={7} color="secondary" variant="outlined" />
                                </ListItemIcon>
                                <ListItemText primary="Dashboard" />
                              </ListItemButton>
                              <ListItemButton disableRipple component={Link} href="/wallet">
                                <ListItemIcon>
                                  <Dot size={7} color="secondary" variant="outlined" />
                                </ListItemIcon>
                                <ListItemText primary="Wallet" />
                              </ListItemButton>
                              <ListItemButton disableRipple component={Link} href="/marketplace">
                                <ListItemIcon>
                                  <Dot size={7} color="secondary" variant="outlined" />
                                </ListItemIcon>
                          ...
                          <Grid item xs={4}>
                            ...
                            >
                              <ListItemButton disableRipple component={Link} href="/help-center">
                                <ListItemIcon>
                                  <Dot size={7} color="secondary" variant="outlined" />
                                </ListItemIcon>
                                <ListItemText primary="Help Center" />
                              </ListItemButton>
                              <ListItemButton disableRipple component={Link} href="/faqs">
                                <ListItemIcon>
                                  <Dot size={7} color="secondary" variant="outlined" />
                                </ListItemIcon>
                                <ListItemText primary="FAQs" />
                              </ListItemButton>
                              <ListItemButton disableRipple component={Link} href="/support">
                                <ListItemIcon>
                                  <Dot size={7} color="secondary" variant="outlined" />
                                </ListItemIcon>
                          ...
                          <Grid item xs={4}>
                            ...
                            >
                              <ListItemButton disableRipple component={Link} href="/staking">
                                <ListItemIcon>
                                  <Dot size={7} color="secondary" variant="outlined" />
                                </ListItemIcon>
                                <ListItemText primary="Staking" />
                              </ListItemButton>
                              <ListItemButton disableRipple component={Link} href="/tokenization">
                                <ListItemIcon>
                                  <Dot size={7} color="secondary" variant="outlined" />
                                </ListItemIcon>
                                <ListItemText primary="Tokenization" />
                              </ListItemButton>
                            </List>
                          </Grid>
                        </Grid>
